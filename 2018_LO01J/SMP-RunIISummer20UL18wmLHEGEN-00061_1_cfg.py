...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'JetMatching:scheme = 1', # kT scheme
            'JetMatching:merge = on',
            'JetMatching:jetAlgorithm = 2',  # 1=cone, 2=kT
            'JetMatching:etaJetMax = 5.',
            'JetMatching:coneRadius = 1.0',
            'JetMatching:slowJetPower = 1',
            'JetMatching:qCut = 25.',        # matching scale (must match gridpack qCut=xqcut + 10 GeV) 
            'JetMatching:nQmatch = 5',       # 5F scheme (b-quarks matched as light)
            'JetMatching:nJetMax = 1',       # highest multiplicity ME in gridpack
