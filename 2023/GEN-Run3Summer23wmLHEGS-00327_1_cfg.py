...
# with command line options: Configuration/GenProduction/python/GEN-Run3Summer23wmLHEGS-00327-fragment.py --era Run3_2023 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot Realistic25ns13p6TeVEarly2023Collision --step LHE,GEN,SIM --geometry DB:Extended --conditions 130X_mcRun3_2023_realistic_v14 --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(87) --datatier GEN-SIM,LHE --eventcontent RAWSIM,LHE --python_filename GEN-Run3Summer23wmLHEGS-00327_1_cfg.py --fileout file:GEN-Run3Summer23wmLHEGS-00327.root --number 454 --number_out 100 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/GEN-Run3Summer23wmLHEGS-00327-fragment.py nevts:454'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN-Run3Summer23wmLHEGS-00327.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN-Run3Summer23wmLHEGS-00327_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/work/m/mseidel/public/MiNNLO-gridpacks/Zj_slc7_amd64_gcc10_CMSSW_12_3_1_ZJToMuMu-13p6TeV-suggested-nnpdf31-ncalls-doublefsr-q139-powheg-MiNNLO31-svn3900-ew-rwl6-j200-st2fix-ana-hoppetweights-ymax20-pdf3.tgz'),
    generateConcurrently = cms.untracked.bool(False),
    nEvents = cms.untracked.uint32(454),
