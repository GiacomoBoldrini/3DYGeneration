...
process.maxEvents = cms.untracked.PSet(
    ...
    output = cms.untracked.int32(123)
)

# Input source
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:GEN-Run3Summer23DRPremix-00237_0.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--era nevts:123'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN-Run3Summer23DRPremix-00237.root'),
