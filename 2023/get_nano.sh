...
# Dump actual test code to a GEN-Run3Summer23NanoAODv12-00237_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > GEN-Run3Summer23NanoAODv12-00237_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --scenario pp --era Run3_2023 --customise Configuration/DataProcessing/Utils.addMonitoring --step NANO --conditions 130X_mcRun3_2023_realistic_v14 --datatier NANOAODSIM --eventcontent NANOEDMAODSIM --python_filename GEN-Run3Summer23NanoAODv12-00237_1_cfg.py --fileout file:GEN-Run3Summer23NanoAODv12-00237.root --filein "dbs:/DYto2L-2Jets_MLL-50_1J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/Run3Summer23MiniAODv4-130X_mcRun3_2023_realistic_v14-v4/MINIAODSIM" --number 1763 --number_out 1763 --no_exec --mc || exit $? ;

# End of GEN-Run3Summer23NanoAODv12-00237_test.sh file
EndOfTestFile

# Make file executable
chmod +x GEN-Run3Summer23NanoAODv12-00237_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/GEN-Run3Summer23NanoAODv12-00237_test.sh)
