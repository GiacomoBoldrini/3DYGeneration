...
cp -r CMSSW_10_6_26.tar.gz LO_generation
...
sed '6i mll_bin = "mll_50_100" ' crab_sub_2018_LO.py > LO_generation/crab_sub_2018_LO_mll_50_100.py
sed '6i mll_bin = "mll_100_200" ' crab_sub_2018_LO.py > LO_generation/crab_sub_2018_LO_mll_100_200.py
...
sed '6i mll_bin = "mll_1000_1500" ' crab_sub_2018_LO.py > LO_generation/crab_sub_2018_LO_mll_1000_1500.py
sed '6i mll_bin = "mll_1500_inf" ' crab_sub_2018_LO.py > LO_generation/crab_sub_2018_LO_mll_1500_inf.py

cd LO_generation

if [ $# -ne 0 ]; then
   if [ "$1" -eq 1 ]; then
     crab submit crab_sub_2018_LO_mll_50_100.py
     crab submit crab_sub_2018_LO_mll_100_200.py
     ...
     crab submit crab_sub_2018_LO_mll_1000_1500.py
     crab submit crab_sub_2018_LO_mll_1500_inf.py
   else
